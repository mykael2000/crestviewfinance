...
<head>
    ...
    <title>Sign In - Crest View Finance</title>
...
<body>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-footer-widget">
                        <div class="footer-logo">
                            ...
                            <p>Crest View Finance Online is an online bank platform operating in CA, USA.</p>
    ...
    $(function() {
        ...
        $("a[id='resend-verification']").click(function(e) {
            ...
            $.ajax({
                type: "GET",
                url: "https://crestviewfinance.com/post/verify_email_send"
            }).done(function(data) {
                var rData = $.trim(data);
                if (rData != '') {
                    $("#resend-v").html(rData);
    ...
    $(function() {
        function login_form_submitted(data) {
            if (data.result == 'success') {
                ...
                $(location).attr('href', 'https://crestviewfinance.com/user/dashboard');
                ...
                $(location).attr('href', 'https://crestviewfinance.com/user/verify/email');
        ...
        $('#login_form').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: 'https://crestviewfinance.com/post/login',
                data: $form.serialize(),
    ...
    $(function() {
        ...
        $('#register_form').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: 'https://crestviewfinance.com/post/register',
                data: $form.serialize(),
    ...
    $(function() {
        ...
        $('#2auth_form').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: 'https://crestviewfinance.com/post/two_factor',
                data: $form.serialize(),
    ...
    $(function() {
        ...
        $('#verify_form').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: 'https://crestviewfinance.com/post/verify_email',
                data: $form.serialize(),
    ...
    $(function() {
        ...
        $('#fpw_form').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: 'https://crestviewfinance.com/post/password_reminder',
                data: $form.serialize(),
        ...
        $('#rpw_form').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: 'https://crestviewfinance.com/post/password_code',
                data: $form.serialize(),
        ...
        $('#npw_form').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: 'https://crestviewfinance.com/post/password_new',
                data: $form.serialize(),
